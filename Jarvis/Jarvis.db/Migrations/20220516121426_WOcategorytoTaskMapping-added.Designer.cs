...
namespace Jarvis.db.Migrations
{
    ...
    [Migration("20220516121426_WOcategorytoTaskMapping-added")]
    partial class WOcategorytoTaskMappingadded
    {
            ...
            modelBuilder.Entity("Jarvis.db.Models.Asset", b =>
                {
                    ...
                    b.HasOne("Jarvis.db.Models.InspectionsTemplateFormIO", "InspectionsTemplateFormIO")
                        .WithOne("Asset")
                        .HasForeignKey("Jarvis.db.Models.Asset", "form_id");
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetFormIO", b =>
                {
                    b.HasOne("Jarvis.db.Models.Asset", "Asset")
                        .WithOne("AssetFormIO")
                        .HasForeignKey("Jarvis.db.Models.AssetFormIO", "asset_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jarvis.db.Models.WOInspectionsTemplateFormIOAssignment", b =>
                {
                    ...
                    b.HasOne("Jarvis.db.Models.WorkOrders", "WorkOrders")
                        .WithOne("WOInspectionsTemplateFormIOAssignment")
                        .HasForeignKey("Jarvis.db.Models.WOInspectionsTemplateFormIOAssignment", "wo_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Jarvis.db.Models.WOcategorytoTaskMapping", b =>
                {
                    b.HasOne("Jarvis.db.Models.Tasks", "Tasks")
                        ...
                        .HasForeignKey("Jarvis.db.Models.WOcategorytoTaskMapping", "task_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
