...
namespace Jarvis.db.Migrations
{
    ...
    [Migration("20230901073137_asset_componant_level-added")]
    partial class asset_componant_leveladded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jarvis.db.Models.Asset", b =>
                {
                    ...
                    b.Property<int>("componant_level_type_id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetSubLevelcomponantMapping", b =>
                {
                    b.Property<Guid>("asset_sublevelcomponant_mapping_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("sublevelcomponant_asset_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("asset_sublevelcomponant_mapping_id");

                    b.HasIndex("asset_id");

                    b.HasIndex("site_id");

                    b.ToTable("AssetSubLevelcomponantMapping");
                });
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetTopLevelcomponantMapping", b =>
                {
                    b.Property<Guid>("asset_toplevelcomponant_mapping_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("toplevelcomponant_asset_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("asset_toplevelcomponant_mapping_id");

                    b.HasIndex("asset_id");

                    b.HasIndex("site_id");

                    b.ToTable("AssetTopLevelcomponantMapping");
                });
            ...
            modelBuilder.Entity("Jarvis.db.Models.WOlineSubLevelcomponantMapping", b =>
                {
                    b.Property<Guid>("woline_sublevelcomponant_mapping_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("is_sublevelcomponant_from_ob_wo")
                        .HasColumnType("boolean");
                    ...
                    b.HasKey("woline_sublevelcomponant_mapping_id");

                    b.HasIndex("site_id");

                    b.HasIndex("woonboardingassets_id");

                    b.ToTable("WOlineSubLevelcomponantMapping");
                });

            modelBuilder.Entity("Jarvis.db.Models.WOlineTopLevelcomponantMapping", b =>
                {
                    b.Property<Guid>("woline_toplevelcomponant_mapping_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("is_toplevelcomponant_from_ob_wo")
                        .HasColumnType("boolean");
                    ...
                    b.HasKey("woline_toplevelcomponant_mapping_id");

                    b.HasIndex("site_id");

                    b.HasIndex("woonboardingassets_id");

                    b.ToTable("WOlineTopLevelcomponantMapping");
                });
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetSubLevelcomponantMapping", b =>
                {
                    b.HasOne("Jarvis.db.Models.Asset", "Asset")
                        .WithMany("AssetSubLevelcomponantMapping")
                        .HasForeignKey("asset_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetTopLevelcomponantMapping", b =>
                {
                    b.HasOne("Jarvis.db.Models.Asset", "Asset")
                        .WithMany("AssetTopLevelcomponantMapping")
                        .HasForeignKey("asset_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jarvis.db.Models.WOlineSubLevelcomponantMapping", b =>
                {
                    ...
                    b.HasOne("Jarvis.db.Models.WOOnboardingAssets", "WOOnboardingAssets")
                        .WithMany("WOlineSubLevelcomponantMapping")
                        .HasForeignKey("woonboardingassets_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Jarvis.db.Models.WOlineTopLevelcomponantMapping", b =>
                {
                    ...
                    b.HasOne("Jarvis.db.Models.WOOnboardingAssets", "WOOnboardingAssets")
                        .WithMany("WOlineTopLevelcomponantMapping")
                        .HasForeignKey("woonboardingassets_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
