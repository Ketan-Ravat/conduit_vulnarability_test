...
namespace Jarvis.db.Migrations
{
    ...
    [Migration("20191129132146_CreateInspection1")]
    partial class CreateInspection1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jarvis.db.Models.Asset", b =>
                {
                    ...
                    b.Property<AssetsValueJsonObject[]>("lastinspection_attribute_values")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetTransactionHistory", b =>
                {
                    ...
                    b.Property<AssetsValueJsonObject>("attributeValues")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Jarvis.db.Models.AssetsValueJsonObject", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AssetsValueJsonObject");
                });
            ...
            modelBuilder.Entity("Jarvis.db.Models.Inspection", b =>
                {
                    ...
                    b.Property<Guid?>("attribute_valuesid")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Jarvis.db.Models.StatusMaster", b =>
                {
                    ...
                    b.Property<long>("status_type_id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Jarvis.db.Models.Inspection", b =>
                {
                    b.HasOne("Jarvis.db.Models.Asset", null)
                        .WithMany("Inspection")
                        .HasForeignKey("asset_id");

                    b.HasOne("Jarvis.db.Models.AssetsValueJsonObject", "attribute_values")
                        .WithMany()
                        .HasForeignKey("attribute_valuesid");
