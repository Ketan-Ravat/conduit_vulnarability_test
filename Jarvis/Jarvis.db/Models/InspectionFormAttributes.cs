...
{
    public class InspectionFormAttributes
    {
        [Key]
        ...
        [ForeignKey("InspectionAttributeCategory")]
        ...
        public virtual InspectionAttributeCategory InspectionAttributeCategory { get; set; }
