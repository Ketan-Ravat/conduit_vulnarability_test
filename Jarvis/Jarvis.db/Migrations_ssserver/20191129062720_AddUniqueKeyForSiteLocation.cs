...
{
    public partial class AddUniqueKeyForSiteLocation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    asset_requested_by = table.Column<string>(nullable: true),
                    asset_requested_on = table.Column<DateTime>(nullable: true),
                    asset_approved_by = table.Column<string>(nullable: true),
                    asset_approved_on = table.Column<DateTime>(nullable: true),
