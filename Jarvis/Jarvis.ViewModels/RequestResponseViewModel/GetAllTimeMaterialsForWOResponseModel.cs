...
{
    public class GetAllTimeMaterialsForWOResponseModel
    {
        public List<TimeMaterials_Data> time_materials_list { get; set; }
        public int listsize { get; set; }
        public double sum_of_all_markup_amount { get; set; }
        public int labor_count { get; set; }
        public int material_count { get; set; }
        public int miscellaneous_count { get; set; }
    }

    public class TimeMaterials_Data
    {
